          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              <div className="hidden lg:flex space-x-4">
                ...
                {isEmpleado && ( // Mostrar solo si el usuario es un empleado (isEmpleado es true)
                  <Link
                    to="/App/Stock"
                ...
                {!isEmpleado && ( // Mostrar solo si el usuario NO es un empleado (es decir, es un administrador o cliente)
                  <Link
                    to="/App/Pedido"
